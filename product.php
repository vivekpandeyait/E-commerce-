				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<p>Welcome to digital shop here showing all the product and information are unique ,thats my first priority to make them accessible is user friendly.</p>
                ...
                if(mysqli_num_rows($run_query) > 0){
                    ...
                    while($row = mysqli_fetch_array($run_query)){
                        ...
                        echo "
								...
								<a href='#=$pro_id'><div class='product'>
